...
def main():
    ...
    environment_variables["REMOTE_TRAJECTORY_PATH"] = "/scratch/${SLURM_JOB_USER}/${SLURM_JOB_ID}/trajectories"
            ...
            for version_index, compared_version in enumerate(experiment["compared_versions"]):
                ...
                while sid is None:
                    sid = submit_job_and_validate_execution(
                        ...
                        arguments,
                        environment_variables,
                        f"{experiment['domain_file_name']}_{fold}_{learning_algorithms_map[compared_version]}_experiment_runner",
                        None,
                        memory="32G",
                    )
                ...
                print(
                    f"{formatted_date_time} - submitted job with sid {sid} for algorithm {learning_algorithms_map[compared_version]} fold {fold}."
                )
