...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=DEFAULT_EXPERIMENT_SIZE,
        type=int,
    )
    parser.add_argument(
...
class FoldsCreator:
    ...
    def create_random_performance_evaluation_trajectories(
        ...
        for fold in range(self.k_fold.n_split):
            ...
            test_set_directory = (
                self.k_fold.test_set_dir_path / f"fold_{fold}_{learning_algorithm}{'_1' if self._internal_iterations is not None else ''}"
            )
            ...
            if should_include_random_trajectories:
                ...
                random_trajectories_creator.create_domain_trajectories(
                    problems_prefix=problem_prefix, output_directory_path=output_directory_path
                )
