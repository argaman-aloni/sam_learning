...
class MultiAgentExperimentRunner(OfflineBasicExperimentRunner):
    ...
    def learn_baseline_action_model(
        ...
        self.validate_learned_domain(allowed_filtered_observations, learned_model, test_set_dir_path, fold_num, learning_time)
    ...
    def learn_ma_action_model(
        ...
        learning_time = float(learning_report["learning_time"])
        self.validate_learned_domain(allowed_complete_observations, learned_model, test_set_dir_path, fold_num, learning_time)
