...
class FoldsCreator:
    ...
    def __init__(self, working_directory_path: Path, domain_file_name: str, learning_algorithms: List[int] = None,
        ...
        self.k_fold = DistributedKFoldSplit(
            ...
            learning_algorithms=learning_algorithms, internal_iterations=internal_iterations)
...
if __name__ == '__main__':
    ...
    FoldsCreator(working_directory_path=Path(args.working_directory_path),
                 ...
                 internal_iterations=internal_iterations).create_folds_from_cross_validation()
