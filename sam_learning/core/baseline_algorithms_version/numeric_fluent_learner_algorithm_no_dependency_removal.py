...
from sam_learning.core.baseline_algorithms_version.convex_hull_learner_no_dependency_removal import ConvexHullLearnerNoDependencyRemoval
...
class NumericFluentStateStorageNoDependencyRemoval:
    ...
    def __init__(self, action_name: str, domain_functions: Dict[str, PDDLFunction], polynom_degree: int = 0):
        ...
        self.convex_hull_learner = ConvexHullLearnerNoDependencyRemoval(action_name, domain_functions, polynom_degree=polynom_degree)
