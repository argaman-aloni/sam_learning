...
class IncrementalConvexHullLearner(ConvexHullLearner):
    ...
    def add_point_to_data(self, point: Dict[str, float], relevant_fluents: Optional[List[str]] = []) -> None:
        """Adds a point to the data that will be used to construct the convex hull."""
