...
class SAMLearner:
    ...
    def _add_negative_predicates(self, grounded_action: ActionCall, previous_state: State,
        ...
        :param previous_state: the state previous to the action's activation.
        ...
        """
        possible_negative_preconditions = set()
