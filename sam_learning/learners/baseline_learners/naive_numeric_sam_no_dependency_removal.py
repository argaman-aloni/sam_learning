...
from sam_learning.core.baseline_algorithms_version.naive_numeric_fluent_learner_algorithm_no_dependency_removal import (
    NaiveNumericFluentStateStorageNoDependencyRemoval,
)
...
class NaiveNumericSAMLearnerNoDependencyRemoval(SAMLearner):
    """The Extension of SAM that is able to learn numeric state variables."""

    storage: Dict[str, NaiveNumericFluentStateStorageNoDependencyRemoval]
