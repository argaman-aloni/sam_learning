...
from sam_learning.core.baseline_algorithms_version.numeric_fluent_learner_algorithm_no_dependency_removal import (
    NumericFluentStateStorageNoDependencyRemoval,
)
...
class NumericSAMLearnerNoDependencyRemoval(SAMLearner):
    """The Extension of SAM that is able to learn numeric state variables."""

    storage: Dict[str, NumericFluentStateStorageNoDependencyRemoval]
    ...
    def add_new_action(self, grounded_action: ActionCall, previous_state: State, next_state: State) -> None:
        ...
        self.storage[grounded_action.name] = NumericFluentStateStorageNoDependencyRemoval(
