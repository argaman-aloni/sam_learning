...
def test_add_not_effect_to_an_action_adds_the_predicate_to_the_not_effects_set(literals_cnf: LiteralCNF, combined_domain: Domain):
...
def test_add_possible_effect_to_an_action_adds_the_predicate_to_the_possible_effects_set(literals_cnf: LiteralCNF, combined_domain: Domain):
    possible_effects = [
...
def test_add_not_effect_to_an_action_removes_relevant_options_from_maybe_effects_in_the_cnf(literals_cnf: LiteralCNF, combined_domain: Domain):
    possible_effects = [
        ("do-plane", "(has-colour ?agent ?colour)"),
        ("do-immersion-varnish", "(has-colour ?agent ?newcolour)"),
        ("do-grind", "(has-colour ?agent ?oldcolour)"),
...
def test_add_possible_effect_does_not_add_effect_to_an_action_if_effect_declared_as_not_effect(literals_cnf: LiteralCNF, combined_domain: Domain):
    possible_effects = [
        ("do-plane", "(has-colour ?agent ?colour)"),
        ("do-immersion-varnish", "(has-colour ?agent ?newcolour)"),
        ("do-grind", "(has-colour ?agent ?oldcolour)"),
...
def test_is_action_safe_when_an_action_contains_ambiguity_returns_that_action_is_not_safe(literals_cnf: LiteralCNF, combined_domain: Domain):
    possible_effects = [
        ("do-plane", "(has-colour ?agent ?colour)"),
        ("do-immersion-varnish", "(has-colour ?agent ?newcolour)"),
        ("do-grind", "(has-colour ?agent ?oldcolour)"),
...
def test_is_action_safe_when_an_actions_effect_declared_as_not_effect_considered_as_safe(literals_cnf: LiteralCNF, combined_domain: Domain):
    possible_effects = [
        ("do-plane", "(has-colour ?agent ?colour)"),
        ("do-immersion-varnish", "(has-colour ?agent ?newcolour)"),
        ("do-grind", "(has-colour ?agent ?oldcolour)"),
...
def test_is_action_acting_in_cnf_recognize_when_action_is_in_the_cnf(literals_cnf: LiteralCNF, combined_domain: Domain):
    possible_effects = [
        ("do-plane", "(has-colour ?agent ?colour)"),
        ("do-immersion-varnish", "(has-colour ?agent ?newcolour)"),
        ("do-grind", "(has-colour ?agent ?oldcolour)"),
...
def test_is_action_acting_in_cnf_recognize_when_action_is_in_the_cnf_as_not_effect(literals_cnf: LiteralCNF, combined_domain: Domain):
    literals_cnf.add_not_effect("do-plane", combined_domain.predicates["has-colour"])
    assert literals_cnf.is_action_acting_in_cnf("do-plane")


def test_is_action_acting_in_cnf_recognize_when_action_is_not_in_cnf(literals_cnf: LiteralCNF, combined_domain: Domain):
    assert not literals_cnf.is_action_acting_in_cnf("do-spray-varnish")


def test_extract_action_effects_extract_an_action_effect_only_from_unit_clause_cnfs(literals_cnf: LiteralCNF, combined_domain: Domain):
    possible_effects = [("do-immersion-varnish", "(has-colour ?agent ?newcolour)"), ("do-grind", "(has-colour ?agent ?oldcolour)")]
    literals_cnf.add_possible_effect(possible_effects)
    literals_cnf.add_possible_effect([("do-plane", "(has-colour ?agent ?colour)")])
...
def test_extract_action_effects_extract_an_action_effect_from_non_unit_clause_returns_empty_list(literals_cnf: LiteralCNF, combined_domain: Domain):
    possible_effects = [
        ("do-immersion-varnish", "(has-colour ?agent ?newcolour)"),
        ("do-grind", "(has-colour ?agent ?oldcolour)"),
        ("do-plane", "(has-colour ?agent ?colour)"),
