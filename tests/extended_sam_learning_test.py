...
from sam_learning.learners import SAMLearner, ExtendedSAM
from tests.consts import ELEVATORS_DOMAIN_PATH, ELEVATORS_PROBLEM_PATH, ELEVATORS_TRAJECTORY_PATH, \
    WOODWORKING_DOMAIN_PATH, WOODWORKING_PROBLEM_PATH, WOODWORKING_TRAJECTORY_PATH
...
def test_add_new_action_with_single_trajectory_component_adds_action_data_to_learned_domain(
        esam_learning: ExtendedSAM, woodworking_observation: Observation, woodworking_problem: Problem):
