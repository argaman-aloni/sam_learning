...
(:action do-saw-small
	...
	:effect       (and (colour ?p natural) (available ?p) (treatment ?p untreated) (wood ?p ?w) (boardsize ?b ?size_after) (surface-condition ?p ?surface) (not (unused ?p))))
...
(:action do-saw-medium
	...
	:effect       (and (colour ?p natural) (available ?p) (boardsize ?b ?size_after) (wood ?p ?w) (treatment ?p untreated) (surface-condition ?p ?surface) (not (unused ?p))))
...
(:action do-saw-large
	...
	:effect       (and (colour ?p natural) (treatment ?p untreated) (surface-condition ?p ?surface) (wood ?p ?w) (available ?p) (boardsize ?b ?size_after) (not (unused ?p))))
...
(:action do-plane
	...
	:effect       (and (treatment ?x untreated) (surface-condition ?x smooth) (colour ?x natural) (not (treatment ?x ?oldtreatment)) (not (surface-condition ?x ?oldsurface)) (not (colour ?x ?oldcolour))))
...
(:action cut-board-small
	...
	:effect       (and (boardsize ?b ?size_after) (available ?p) (wood ?p ?w) (surface-condition ?p ?surface) (colour ?p natural) (treatment ?p untreated) (not (unused ?p))))
...
(:action cut-board-medium
	...
	:effect       (and (colour ?p natural) (treatment ?p untreated) (boardsize ?b ?size_after) (available ?p) (wood ?p ?w) (surface-condition ?p ?surface) (not (unused ?p))))
...
(:action cut-board-large
	...
	:effect       (and (wood ?p ?w) (surface-condition ?p ?surface) (colour ?p natural) (treatment ?p untreated) (boardsize ?b ?size_after) (available ?p) (not (unused ?p))))
...
(:action do-grind
	...
	:effect       (and (surface-condition ?x verysmooth) (colour ?x natural) (treatment ?x ?newtreatment) (not (colour ?x ?oldcolour)) (not (treatment ?x ?oldtreatment)) (not (surface-condition ?x ?oldsurface))))
