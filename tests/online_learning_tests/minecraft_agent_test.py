...
def test_get_environment_actions_gets_only_legal_teleport_actions(
...
def test_get_environment_actions_gets_only_one_craft_wooden_pogo_action(
        minecraft_agent: MinecraftAgent, minecraft_large_problem: Problem):
    # Arrange
    state_predicates = minecraft_large_problem.initial_state_predicates
    state_fluents = minecraft_large_problem.initial_state_fluents
    ...
    assert len([action for action in total_grounded_actions if
                action.name == "craft_wooden_pogo"]) == num_expected_pogo_actions


def test_get_environment_actions_gets_only_one_break_action(
        minecraft_agent: MinecraftAgent, minecraft_large_problem: Problem):
    # Arrange
    state_predicates = minecraft_large_problem.initial_state_predicates
    state_fluents = minecraft_large_problem.initial_state_fluents
    ...
    assert len([action for action in total_grounded_actions if
                action.name == "break"]) == num_expected_pogo_actions


def test_get_environment_actions_gets_only_one_creaft_tree_tap_action(
        minecraft_agent: MinecraftAgent, minecraft_large_problem: Problem):
    # Arrange
    state_predicates = minecraft_large_problem.initial_state_predicates
    state_fluents = minecraft_large_problem.initial_state_fluents
    ...
    assert len([action for action in total_grounded_actions if
                action.name == "craft_tree_tap"]) == num_expected_pogo_actions
