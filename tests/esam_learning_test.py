...
from tests.consts import ROVERS_COMBINED_ESAM_PROBLEM_PATH, ROVERS_COMBINED_ESAM_TRAJECTORY_PATH, ROVERS_ESAM_DOMAIN_PATH
...
def assert_get_minimize_parameters_equality_dict(
    ...
    output = get_minimize_parameters_equality_dict(model_dict=model_dict, act_signature=action_signature, domain_types=types)
    assert output == expected_output


def test_get_minimize_parameters_equality_dict1(rovers_esam_learner: ExtendedSamLearner, rovers_esam_observation: Observation):
    ...
    assert_get_minimize_parameters_equality_dict(
        rovers_esam_learner, communicate_soil_dict1, {"?x": "?p", "?y": "?x", "?p": "?p", "?r": "?r", "?l": "?l"}
    )
    ...
    assert_get_minimize_parameters_equality_dict(
        rovers_esam_learner, communicate_soil_dict2, {"?x": "?x", "?y": "?y", "?p": "?p", "?r": "?r", "?l": "?l"}
    )
    # ===================================================================================
    ...
    assert_get_minimize_parameters_equality_dict(
        rovers_esam_learner, communicate_soil_dict3, {"?x": "?x", "?y": "?y", "?p": "?p", "?r": "?r", "?l": "?l"}
    )


# more complex formulas
def test_get_minimize_parameters_equality_dict2(rovers_esam_learner: ExtendedSamLearner, rovers_esam_observation: Observation):
    # ========================================================================
    # ========================test set 2======================================
    # ========================================================================
    pred1: str = "(communicated_soil_data ?p - waypoint)"
    ...
    assert_get_minimize_parameters_equality_dict(
        rovers_esam_learner, communicate_soil_dict1, {"?p": "?p", "?x": "?p", "?y": "?p", "?r": "?r", "?l": "?l"}
    )
    ...
    assert_get_minimize_parameters_equality_dict(
        rovers_esam_learner, communicate_soil_dict2, {"?p": "?p", "?x": "?p", "?y": "?x", "?r": "?r", "?l": "?l"}
    )
    ...
    assert_get_minimize_parameters_equality_dict(
        rovers_esam_learner, communicate_soil_dict3, {"?p": "?p", "?x": "?x", "?y": "?p", "?r": "?r", "?l": "?l"}
    )
    ...
    assert_get_minimize_parameters_equality_dict(
        rovers_esam_learner, communicate_soil_dict4, {"?p": "?p", "?x": "?x", "?y": "?x", "?r": "?r", "?l": "?l"}
    )
    # 5============================================5
    ...
    assert_get_minimize_parameters_equality_dict(
        rovers_esam_learner, communicate_soil_dict5, {"?p": "?p", "?x": "?x", "?y": "?y", "?r": "?r", "?l": "?l"}
    )
    ...
    assert_get_minimize_parameters_equality_dict(
        rovers_esam_learner, communicate_soil_dict6, {"?p": "?p", "?x": "?x", "?y": "?y", "?r": "?r", "?l": "?l"}
    )
    # 7============================================7
    ...
    assert_get_minimize_parameters_equality_dict(
        rovers_esam_learner, communicate_soil_dict7, {"?p": "?p", "?x": "?x", "?y": "?y", "?r": "?r", "?l": "?l"}
    )
